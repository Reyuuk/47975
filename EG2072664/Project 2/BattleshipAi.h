...
//Class Specification and implementation for Battleship Ai class
...
class BattleshipAi : public Player<int>
{
private:
	int ** hitboard;	//tracks where hits have occured
	bool sunk;			//tracks if a ship was sunk since last hit, used in determining which mode to enter
	int x;				//coordinates of next attack
	int y;				//coordinates of next attack
	int lhx;			//coordinates of last confirmed hit
	int lhy;			//coordinates of last confirmed hit
	int fhx;			//coordinates of the first hit on a ship (used in attack algorithm)
	int fhy;			//coordinates of the first hit on a ship (used in attack algorithm)

	void randHuntCoords();
	bool attackModeCoordsBias(int, int);
	bool attackModeCoords(int, int);
...
public:
	...
	void placeShipRandom(int &, int &, char &);
	void selectAttackPoint(int &, int&);

	void getResults(int hit);
...
//this function searches the nearby spaces for a possible next attack location using bias
...
//this function searches the nearby spaces for a possible next attack location. Attacks any available position.
